...
if ( ! function_exists( 'innatiive_pagination' ) ) {
	/**
	 ...
	 */
	function innatiive_pagination( $args = array(), $class = 'pagination' ) {
		...
		$args = wp_parse_args(
			...
			array(
				'mid_size'           => 2,
				'prev_next'          => true,
				'prev_text'          => __( '&laquo;', 'innatiive' ),
				'next_text'          => __( '&raquo;', 'innatiive' ),
				'type'               => 'array',
				'current'            => max( 1, get_query_var( 'paged' ) ),
				'screen_reader_text' => __( 'Posts navigation', 'innatiive' ),
			)
		);
