	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'innatiive' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'innatiive' ); ?></th>
			</tr>
		</thead>
		<tbody>
